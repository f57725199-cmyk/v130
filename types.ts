...
export interface SystemSettings {
  ...
  storeBannerText?: string; // NEW: Store Offer Banner
...
export type StudentTab = 'HOME' | 'SEASON' | 'COURSES' | 'ROUTINE' | 'CHAT' | 'HISTORY' | 'REDEEM' | 'PREMIUM' | 'GAME' | 'WEEKLY_TEST' | 'PROFILE' | 'LEADERBOARD' | 'STORE' | 'VIDEO' | 'PDF' | 'MCQ';
